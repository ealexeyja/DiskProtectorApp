...
echo "=== Script completo de compilación y prueba v1.2.6 ==="

# 1. Actualizar la versión en el proyecto
cat > update-version.sh << 'UPDATEVERSIONEOF'
#!/bin/bash
...
echo "3. git commit -m \"release: v$NEW_VERSION - Actualización de versión\""
