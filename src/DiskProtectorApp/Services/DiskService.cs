...
namespace DiskProtectorApp.Services
{
    ...
    public class DiskService
    {
        ...
        public List<DiskInfo> GetDisks()
        {
            ...
            AppLogger.LogService("[DISK_DEBUG] Iniciando obtención de discos");
            ...
            AppLogger.LogService($"[DISK_DEBUG] Obtención de discos completada. Total de unidades: {disks.Count}");
            return disks;
