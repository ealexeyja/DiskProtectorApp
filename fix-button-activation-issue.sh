...
echo "=== Corrigiendo activación de botones ==="

# Actualizar el ViewModel para mejor manejo de comandos
...
echo "✅ Correcciones aplicadas para activación de botones"
echo "   Cambios principales:"
echo "   - Mejorada la lógica CanExecute para proteger/desproteger"
echo "   - Agregado logging de debug para diagnóstico"
echo "   - Forzada actualización de comandos"
echo "   - Mejorado el manejo de eventos"
echo ""
echo "Para aplicar los cambios:"
echo "1. git add src/DiskProtectorApp/ViewModels/MainViewModel.cs"
echo "2. git add src/DiskProtectorApp/RelayCommand.cs"
echo "3. git commit -m \"fix: Corregir activación de botones de protección\""
