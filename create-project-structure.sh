...
# Crear archivo global.json con la última versión estable de .NET 6.0
...
# Crear archivo del proyecto principal con la última versión de dependencias
...
# Crear pipeline CI/CD con la última versión del SDK
...
echo "Estructura de proyecto DiskProtectorApp creada exitosamente!"
echo "Para ejecutar el script de creación:"
echo "1. chmod +x create-project-structure.sh"
echo "2. ./create-project-structure.sh"
