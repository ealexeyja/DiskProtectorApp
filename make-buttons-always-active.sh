...
echo "=== Haciendo botones siempre activos para prueba ==="

# Actualizar el ViewModel para que los botones siempre estén activos
...
echo "✅ Botones configurados para estar siempre activos"
echo "   Cambios principales:"
echo "   - CanExecute ahora siempre retorna true (excepto cuando IsWorking=true)"
echo "   - Las funciones de protección/desprotección trabajan con todos los discos seleccionados"
echo "   - Se mantiene el logging para diagnóstico"
echo ""
echo "Para aplicar los cambios:"
echo "1. git add src/DiskProtectorApp/ViewModels/MainViewModel.cs"
echo "2. git commit -m \"feat: Botones siempre activos para prueba de funcionalidad\""
echo "3. git push origin main"
echo ""
echo "Luego ejecuta './build-and-release.sh' para crear una nueva versión"
