...
echo "=== Reforzando sincronización del binding de CheckBox ==="

# Actualizar MainWindow.xaml.cs para forzar la sincronización en el handler de clic
# Esto asegura que el estado del CheckBox se refleje en el modelo incluso si el binding TwoWay falla
...
echo "✅ Sincronización de CheckBox reforzada"
echo "   Cambios principales:"
echo "   - El handler CheckBox_Click ahora fuerza explícitamente la actualización de la propiedad IsSelected del modelo"
echo "   - Se agrega verificación de tipo del DataContext"
echo "   - Se mejora el logging para diagnóstico"
echo ""
echo "Para aplicar los cambios:"
echo "1. git add src/DiskProtectorApp/Views/MainWindow.xaml.cs"
echo "2. git commit -m \"fix: Reforzar sincronización de CheckBox con el modelo\""
