...
echo "=== Corrigiendo DiskInfo.cs ==="

cat > src/DiskProtectorApp/Models/DiskInfo.cs << 'DISKINFOEOF'
...
echo "   - Propiedades correctamente implementadas con notificación"
echo "   - Manejo de nullability corregido"
echo "   - Lógica de selección mejorada"
echo "   - Estados de protección correctamente gestionados"
