...
namespace DiskProtectorApp.Converters
{
    ...
    public class DiskStatusToBrushConverter : IValueConverter
    {
        ...
        private static readonly Color ProtectedColor = Color.FromRgb(61, 90, 59);    // Verde forestal oscuro
        private static readonly Color UnprotectedColor = Color.FromRgb(109, 44, 44);  // Rojo oscuro sobrio
